...
<div id="page-content-wrapper">
    <div id="page-content">
        ...
        <div class="container">
            ...
            <div class="panel">
                <div class="panel-body">
                    <h3 class="title-hero" id="page-title">
                     Management Kereta
                     <p style="font-size: 10px;">Mengatur semua kereta</p>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Tambah Kereta</h4>
                            </div>
            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detailker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="modal fade" id="detail<?php echo e($detailker->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                           ...
                           <div class="example-box-wrapper">
                            <form action="/edit" method="post">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">Nama</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="nama" value="<?php echo e($detailker->nama); ?>">
                                        <input type="hidden" class="form-control" name="id" value="<?php echo e($detailker->id); ?>">  
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;" width="30%">
                            <a href="/rangkaian/<?php echo e($ker->id); ?>"><button class="btn btn-success"><i class="glyph-icon icon-navicon"></i></button></a>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\monarch\resources\views/kereta/management_kereta.blade.php ENDPATH**/ ?>