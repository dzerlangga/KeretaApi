...
<div id="page-content-wrapper">
    <div id="page-content">
        ...
        <div class="container">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                               <div class="example-box-wrapper">
                                <form action="/plusgerbong/<?php echo e($kereta[0]->id); ?>" method="post">
            ...
            <div class="modal fade" id="d_gerbong<?php echo e($ker->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <td style="text-align: center;" width="30%">
                         <a href="/berita/<?php echo e($ker->id); ?>"><button class="btn btn-success"><i class="glyph-icon icon-navicon"></i></button></a>
                        <button class="btn btn-yellow" data-toggle="modal" data-target="#d_gerbong<?php echo e($ker->id); ?>"><i class="glyph-icon icon-pencil"></i></button>
                        <button class="btn btn-danger hapus_gerbong" kode="<?php echo e($ker->id); ?>" no="<?php echo e($ker->no_gerbong); ?>"><i class="glyph-icon icon-trash"></i></button>
                    </td>
                </tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\monarch\resources\views/kereta/data_gerbong.blade.php ENDPATH**/ ?>