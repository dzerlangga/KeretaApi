            ...
            <div class="panel">
                <div class="panel-body">
                    <h3 class="title-hero" id="page-title">
                     Data Laporan
                     <p style="font-size: 10px;">Kereta <?php echo e($kereta[0]->nama); ?> Gerbong <?php echo e($data2[0]->no_gerbong); ?></p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\monarch\resources\views/kereta/gerbong_k.blade.php ENDPATH**/ ?>