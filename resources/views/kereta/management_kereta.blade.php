...
<div id="page-content-wrapper">
    <div id="page-content">
        ...
        <div class="container">
            ...
            @foreach($data as $detailker)
            <div class="modal fade" id="detail{{ $detailker->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                           ...
                           <div class="example-box-wrapper">
                            <form action="/edit" method="post">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">Nama</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="nama" value="{{ $detailker->nama }}">
                                        <input type="hidden" class="form-control" name="id" value="{{ $detailker->id }}">  
                                    </div>
                                </div>
                            </div>
                        </div>
